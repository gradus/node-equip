...
// I use "factory" here to refer to functions that *return* middlewares.
// If you know or think of a better term lemme know.
plugin.wrapFactory = function (factory) {

  return function wrappedFactory (/*opts*/) {
    // Wrap the created middleware!
    return plugin(middleware.apply(null, arguments));
  }
